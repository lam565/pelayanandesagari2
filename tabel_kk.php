				...
				<section role="main" class="content-body">
					...
					<div class="row">
						 ...
						 <div class="col-12 col-lg-12">
							...
							<center><h2 class="panel-title">Tabel data KK</center>
							...
							<br>
								<div class="table-responsive">
									...
									<table class="table table-striped table-bordered data">
										...
										<tbody>
													<?php
						$a="select * from data_keluarga ";
						$b=mysqli_query($connect,$a) or die ("error:".mysqli_error($connect));
						while($c=mysqli_fetch_array($b)){
						?>
						<tr>
						<td><center><?php echo $c['NO_KK'];?></center></td>
						<td><center><?php echo $c['NIK_KK'];?></center></td>
						<td><center><?php echo $c['NAMA_KEP'];?></center></td>
						<td><center><?php echo $c['DUSUN'];?> RT <?php echo $c['NO_RT'];?>/ RW <?php echo $c['NO_RW'];?>, Gari, Wonosari, Gunungkidul <?php echo $c['KODE_POS'];?></center></td>
						
						

						<td align="center">
						
						<a href="ak.php?kk=<?php echo $c['NO_KK'];?>">Anggota keluarga</a>
