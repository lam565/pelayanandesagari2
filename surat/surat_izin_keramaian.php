...
$pdf->Ln(0.5);
$pdf->Cell(19,$t,'SURAT KETERANGAN IZIN KERAMAIAN', 0, 1, 'C');
$pdf->SetFont('Arial','','11');

$query = "SELECT *FROM biodata_wni,data_keluarga,keramaian,staf,jabatan,jenis_kelamin,status_perkawinan,pekerjaan ,pendidikan_terakhir,agama
where biodata_wni.NIK=keramaian.NIK and biodata_wni.NO_KK=data_keluarga.NO_KK 
...
and staf.id_staf=jabatan.id_staf and keramaian.id_staf=staf.id_staf and keramaian.NIK='$_GET[nik]' and keramaian.tanggal_permohonan='$_GET[tgl]'";
...
$text2="     Orang tersebut diatas adalah benar-benar warga Dusun ".$row['ALAMAT'].", Kalurahan Gari, Kecamatan Wonosari, Kabupaten Gunungkidul dan merupakan Penanggungjawab kegiatan yang akan dilaksanakan pada: ";
$pdf->Ln(0.5);
$pdf->Cell(1,$t,"",0,0,"C");
...
$pdf->Ln(0.1);
$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,' Hari', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['hari'],0,1,"L");

$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,' Tanggal', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['tanggal'],0,1,"L");

$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,' Jam', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['jam'],0,1,"L");

$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,' Jenis Kegiatan', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['jenis_kegiatan'],0,1,"L");

$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,' Lokasi', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['lokasi'],0,1,"L");
$pdf->Ln(0.5);
...
#output file PDF
$pdf->Output("skck_".$_GET['nik']."pdf","I");
