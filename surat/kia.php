...
$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,'10. Nama Lengkap Ayah', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['NAMA_LGKP_AYAH'],0,1,"L");

$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,'10. Nama Lengkap Ibu', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['NAMA_LGKP_IBU'],0,1,"L");

$text2="     Orang tersebut diatas adalah benar-benar warga Dusun ".$row['ALAMAT'].", Desa Gari, Kecamatan Wonosari, Kabupaten Gunungkidul dan orang tersebut diatas belum mempunyai Kartu Identitas Anak ( KIA ). ";
$text3="     Surat keterangan ini diberikan untuk Mengajukan/Mencari KIA ";
...
#output file PDF
$pdf->Output("kia_".$_GET['nik'].".pdf","D");
