...
$query = "SELECT *FROM biodata_wni,data_keluarga,domisili_usaha,staf,jabatan,jenis_kelamin,status_perkawinan,pekerjaan ,pendidikan_terakhir,agama
where biodata_wni.NIK=domisili_usaha.NIK and biodata_wni.NO_KK=data_keluarga.NO_KK 
...
and staf.id_staf=jabatan.id_staf and domisili_usaha.id_staf=staf.id_staf and domisili_usaha.NIK='$_GET[nik]' and domisili_usaha.tanggal_permohonan='$_GET[tgl]'";
...
$text2="     Orang tersebut diatas adalah benar-benar warga Dusun ".$row['ALAMAT'].", Kalurahan Gari, Kecamatan Wonosari, Kabupaten Gunungkidul dan memiliki usaha: ";
$pdf->ln(0.3);
$pdf->Cell(1,$t,'',0,0,"C");
...
$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,'1. Bidang Usaha', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['bidang_usaha'],0,1,"L");

$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,'2. Jenis Usaha', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['jenis_usaha'],0,1,"L");

$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,'3. Lokasi Usaha', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['lokasi_usaha'],0,1,"L");
...
#output file PDF
$pdf->Output("domisili_usaha_".$_GET['nik'].".pdf","D");
