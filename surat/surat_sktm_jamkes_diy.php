...
$pdf->Ln(0.5);
$pdf->Cell(19,$t,'SURAT KETERANGAN TIDAK MAMPU', 0, 1, 'C');
$pdf->SetFont('Arial','','11');

$query = "SELECT *FROM biodata_wni,data_keluarga,kps,staf,jabatan,jenis_kelamin,status_perkawinan,pekerjaan ,pendidikan_terakhir,agama
...
$pdf->Ln(0.5);
$text="     Yang bertanda tangan di bawah ini, Kepala Desa Gari, Kecamatan Wonosari, Kabupaten Gunungkidul, menerangkan dengan sebenarnya bahwa: ";
$pdf->Cell(1,$t,"",0,0,"C");
...
$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,'6. Alamat. Alamat', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
...
$text2="     Orang tersebut diatas adalah benar-benar warga Dusun ".$row['ALAMAT'].", Desa Gari, Kecamatan Wonosari, Kabupaten Gunungkidul, Daerah Istimewa Yogyakarta. Menurut pengamatan kami dan data dilapangan orang tersebut adalah termasuk Keluarga Tidak Mampu ( Keluarg Pra Sejahtera ) juga terlantar. surat keterangan ini dibuat dan diberikan untuk keperluan syarat/lampiran pengajuan permohonan proses jaminan Jamkesos DIY. ";
