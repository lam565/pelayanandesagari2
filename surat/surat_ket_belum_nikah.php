...
$pdf->Ln(0.5);
$pdf->Cell(19,$t,'SURAT KETERANGAN BELUM PERNAH MENIKAH', 0, 1, 'C');
$pdf->SetFont('Arial','','11');
...
$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,'11. Keperluan', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['keperluan'],0,1,"L");

$text2="     Orang tersebut diatas adalah benar-benar warga Dusun ".$row['ALAMAT'].", Kalurahan Gari, Kecamatan Wonosari, Kabupaten Gunungkidul sesuai dengan data yang ada bahwa nama tersebut diatas belum pernah menikah / Status jejak. ";
$text3="     Surat keteranga ini dibuat atas kehendak yang bersangkutan dan akan dipergunakan untuk: ";
$text4="                         PERSYARATAN NUMPANG NIKAH";
$text5="     Demikian Surat Keterangan ini kami buat dengan keadaan yang sebenarnya agar dapat dipergunakan  dengan  sebagaimana  mestinya.";
...
#output file PDF
$pdf->Output("belum_nikah".$_GET['nik'].".pdf","D");
