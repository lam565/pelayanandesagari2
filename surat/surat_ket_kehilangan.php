...
$query = "SELECT *FROM biodata_wni,data_keluarga,kehilangan,staf,jabatan,jenis_kelamin,status_perkawinan,pekerjaan,pendidikan_terakhir,agama
where biodata_wni.NIK=kehilangan.NIK and biodata_wni.NO_KK=data_keluarga.NO_KK 
...
and staf.id_staf=jabatan.id_staf and kehilangan.id_staf=staf.id_staf and kehilangan.NIK='$_GET[nik]' and kehilangan.tanggal_permohonan='$_GET[tgl]'";
...
$text2="     Orang tersebut diatas adalah benar-benar warga Dusun ".$row['ALAMAT'].", Kalurahan Gari, Kecamatan Wonosari, Kabupaten Gunungkidul dan sesuai dengan laporan kehilangan yang kami terima dari yang bersangkutan, bahwa pada: ";
$pdf->Ln(0.5);
$pdf->Cell(1,$t,'',0,0,"C");
...
$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,'1. Hari', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['hari'],0,1,"L");

$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,'2. Tanggal', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['tanggal'],0,1,"L");

$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,'3. Tempat', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['tempat'],0,1,"L");

$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,'4. Barang', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['barang'],0,1,"L");
$pdf->Ln(0.5);
...
#output file PDF
$pdf->Output("kehilangan_".$_GET['nik'].".pdf","D");
