...
$pdf->Cell(5,$t,'8. Pendidikan', '0', 0, 'L');
...
$text2="     Orang tersebut diatas adalah benar-benar warga Dusun ".$row['ALAMAT'].", Kalurahan Gari, Kecamatan Wonosari, Kabupaten Gunungkidul sesuai dengan apa yang tercantum dalam dokumen kependudukan. ";
...
$pdf->Output("domisili_".$_GET['nik'].".pdf","D");
