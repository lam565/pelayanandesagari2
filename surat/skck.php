...
$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,'7. Pendidikan terahir', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['pekerjaan'],0,1,"L");

$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,'8. Agama', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['nama_agama'],0,1,"L");

$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,'9. Alamat', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['ALAMAT'].', Kec. Wonosari, Kab. Gunungkidul',0,1,"L");

$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,'10. Keperluan', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['keperluan'],0,1,"L");

$text2="     Orang tersebut diatas adalah benar-benar warga Dusun ".$row['ALAMAT'].", Kalurahan Gari, Kecamatan Wonosari, Kabupaten Gunungkidul yang selama ini BERKELAKUAN BAIK, tidak pernah tersangkut perkara  tindak  kriminal atau perkara pidana, dan tidak terkait dengan perkumpulan atau organisasi yang dilarang oleh Pemerintah. ";
...
#output file PDF
$pdf->Output("skck_".$_GET['nik'].".pdf","D");
