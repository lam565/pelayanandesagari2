...
$pdf->Ln(0.5);
$pdf->Cell(19,$t,'SURAT KETERANGAN PENGHASILAN', 0, 1, 'C');
$pdf->SetFont('Arial','','11');

$query = "SELECT *FROM biodata_wni,data_keluarga,penghasilan,staf,jabatan,jenis_kelamin,status_perkawinan,pekerjaan ,pendidikan_terakhir,agama
...
$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,'6. Agama', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['nama_agama'],0,1,"L");

$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,'7. Alamat', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['ALAMAT'].', Kec. Wonosari, Kab. Gunungkidul',0,1,"L");

$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,'8. Sekolah/Universitas', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['sekolah'],0,1,"L");

$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,'9. Fakultas', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['fakultas'],0,1,"L");

$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,'10. Kelas', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['kelas'],0,1,"L");


$text2="     Orang tersebut diatas adalah benar-benar warga Dusun ".$row['ALAMAT'].", Kalurahan Gari, Kecamatan Wonosari, Kabupaten Gunungkidul dan merupakan anak dari: ";
$pdf->ln(0.3);
$pdf->Cell(1,$t,'',0,0,"C");
...
$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,'1. Nama Ayah', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['nama_ayah'],0,1,"L");

$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,' Tempat, Tanggal Lahir', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['tempat_lahir']. ', '.date_format(date_create($row['tanggal_lahir']),"d/m/Y"),0,1,"L");

$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,' Pekerjaan', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['pekerjaan'],0,1,"L");

$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,' Alamat', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['ALAMAT'].', Kec. Wonosari, Kab. Gunungkidul',0,1,"L");

$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,' Penghasilan', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['penghasilan'],0,1,"L");

$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,'1. Nama Ibu', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['nama_ibu'],0,1,"L");

$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,' Tempat, Tanggal Lahir', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['tempat_lahir_ibu']. ', '.date_format(date_create($row['tanggal_lahir_ibu']),"d/m/Y"),0,1,"L");

$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,' Alamat', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['alamat_ibu'].', Kec. Wonosari, Kab. Gunungkidul',0,1,"L");

$pdf->Cell(2,$t,"",0,0,"C");
$pdf->Cell(5,$t,' Penghasilan', '0', 0, 'L');
$pdf->Cell(0.5,$t," : ",0,0,"C");
$pdf->Cell(11.5,$t,$row['penghasilan_ibu'],0,1,"L");
$pdf->ln(0.3);
...
#output file PDF
$pdf->Output("penghasilan_".$_GET['nik'].".pdf","I");
