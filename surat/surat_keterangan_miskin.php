...
$query = "SELECT *FROM biodata_wni,data_keluarga,sktm,staf,jabatan,jenis_kelamin,status_perkawinan,pekerjaan ,pendidikan_terakhir,agama
where biodata_wni.NIK=sktm.NIK and biodata_wni.NO_KK=data_keluarga.NO_KK 
...
and staf.id_staf=jabatan.id_staf and sktm.id_staf=staf.id_staf and sktm.NIK='$_GET[nik]' and sktm.tanggal_permohonan='$_GET[tgl]'";
...
$text2="     Orang tersebut diatas adalah benar-benar warga Dusun ".$row['ALAMAT'].", Kalurahan Gari, Kecamatan Wonosari, Kabupaten Gunungkidul sesuai dengan pengamatan kami warga tersebut keadaan perekonomiannya KURANG MAMPU dan termasuk dalam kriteria KELUARGA MISKIN ";
...
#output file PDF
$pdf->Output("sktm_".$_GET['nik'].".pdf","D");
