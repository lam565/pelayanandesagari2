...
$pdf->Cell(15,-2, '                                              SURAT PENGANTAR IZIN KERAMAIAN ', '0', 1, 'C'); 
...
$query = "SELECT *FROM biodata_wni,data_keluarga,keramaian,staf,jabatan,
...
$pdf->Ln(0.5); 
$pdf->Ln(0.5);  
$pdf->Cell(5,0, '              Orang    tersebut    diatas    adalah    benar - benar    warga    Kalurahan    Gari,   Kecamatan  ', '0', 1, 'L'); 
$pdf->Ln(0.5); 
$pdf->Cell(5,0, '      Wonosari,  Kabupaten  Gunungkidul,  dan  merupakan  Penanggung   jawab   Kegiatan  yang  ', '0', 1, 'J');
$pdf->Ln(0.5); 
$pdf->Cell(5,0, '      akan  dilaksanakan   pada :  ', '0', 1, 'J'); 
$pdf->Ln(1); 
$pdf->Cell(5,0, '              Hari	                                         : '.$row['hari']. ' ', '0', 1, 'L');
$pdf->Ln(0.5); 
$pdf->Cell(5,0, '              Tanggal	                                  : '.$row['tanggal']. ' ', '0', 1, 'L');
$pdf->Ln(0.5); 
$pdf->Cell(5,0, '              Waktu 	                                    : '.$row['jam']. ' ', '0', 1, 'L');
$pdf->Ln(0.5); 
$pdf->Cell(5,0, '             Jenis Kegiatan	                         : '.$row['jenis_kegiatan']. ' ', '0', 1, 'L');
$pdf->Ln(0.5); 
$pdf->Cell(5,0, '             Lokasi Kegiatan	                       : '.$row['lokasi']. ' ', '0', 1, 'L');
$pdf->Ln(1);
$pdf->Cell(5,0, '              Demikian  Surat  Pengantar  Izin  Keramaian  ini  kami  sampaikan,  atas  bantuan  dan   ', '0', 1, 'J'); 
$pdf->Ln(0.5);
$pdf->Cell(5,0, '      kerjasamanya  kami  ucapkan  terimakasih.  ', '0', 1, 'J'); 
$pdf->Ln(1);
