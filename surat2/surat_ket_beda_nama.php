...
$query = "SELECT *FROM biodata_wni,data_keluarga,beda_nama,staf,jabatan,
...
$pdf->Ln(0.5); 
$pdf->Ln(0.5);  
$pdf->Cell(5,0, '             Adalah  benar-benar  orang  yang  sama  dengan :   ', '0', 1, 'L'); 
$pdf->Ln(1); 
$pdf->Cell(5,0, '              1.	     Nama Identitas	                 :	'.$row['nama_identitas']. ' ', '0', 1, 'L');
$pdf->Ln(0.5); 
$pdf->Cell(5,0, '              2.	     Nomor Identitas	                :	'.$row['nomor_identitas']. ' ', '0', 1, 'L');
$pdf->Ln(0.5); 
$pdf->Cell(5,0, '              3.	     Nama	                                :	'.$row['nama']. '  ', '0', 1, 'L');
$pdf->Ln(0.5); 
$pdf->Cell(5,0, '              4.	     Tempat, Tanggal Lahir	     : 	'.$row['tempat_lahir']. ', '.$row['tanggal_lahir']. '', '0', 1, 'L');
$pdf->Ln(0.5); 
$pdf->Cell(5,0, '              5.	     Jenis Kelamin	                   : 	'.$row['jens_kelamin']. ' ', '0', 1, 'L');
$pdf->Ln(1);
$pdf->Cell(5,0, '              Namun   terdapat   kesalahan   redaksional   sehingga   berakibat   terjadi   perbedaan   ', '0', 1, 'J'); 
$pdf->Ln(0.5);
$pdf->Cell(5,0, '      DATA  NAMA  pada  kedua  dokumen  tersebut  diatas.  Dokumen  yang  sah  dipergunakan   ', '0', 1, 'J');
$pdf->Ln(0.5);
$pdf->Cell(5,0, '      adalah  Kartu  Tanda  Penduduk.   ', '0', 1, 'J');
$pdf->Ln(1);
$pdf->Cell(5,0, '              Demikian  Surat  Keterangan  ini  kami  buat  dengan  keadaan  yang  sebenarnya  agar    ', '0', 1, 'J'); 
$pdf->Ln(0.5);
$pdf->Cell(5,0, '      dapat dipergunakan dengan sebagaimana mestinya.    ', '0', 1, 'J'); 
$pdf->Ln(1);
