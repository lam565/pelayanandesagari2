...
$pdf->Ln(1); 
$pdf->Cell(5,0, '              Orang   tersebut   diatas  benar-benar   penduduk    Kalurahan  Gari,  Kecamatan Wonosari,  ', '0', 1, 'L'); 
$pdf->Ln(0.5); 
$pdf->Cell(5,0, '      Kabupaten Gunungkidul, dan memiliki usaha :  ', '0', 1, 'J');
$pdf->Ln(1); 
$pdf->Cell(5,0, '              1.	     Bidang Usaha	                   :	'.$row['bidang_usaha']. '', '0', 1, 'L');
$pdf->Ln(0.5); 
$pdf->Cell(5,0, '              2.	     Jenis Usaha	                      :	'.$row['jenis_usaha']. '', '0', 1, 'L');
$pdf->Ln(0.5); 
$pdf->Cell(5,0, '              3.	   	 Lokasi Usaha	                    :	'.$row['lokasi_usaha']. '', '0', 1, 'L');
$pdf->Ln(1);
