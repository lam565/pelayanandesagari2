...
$pdf->Ln(1); 
$pdf->Cell(5,0, '              Orang    tersebut    diatas  benar-benar    warga    Kalurahan   Gari,  Kecamatan  Wonosari,  ', '0', 1, 'L'); 
$pdf->Ln(0.5); 
$pdf->Cell(5,0, '      Kabupaten Gunungkidul, dan sesuai dengan laporan kehilangan yang kami terima dari yang   ', '0', 1, 'J');
$pdf->Ln(0.5); 
$pdf->Cell(5,0, '      bersangkutan, bahwa pada :   ', '0', 1, 'J');
$pdf->Ln(1); 
$pdf->Cell(5,0, '              1.	    Hari	                                 : '.$row['hari']. '', '0', 1, 'L');
$pdf->Ln(0.5); 
$pdf->Cell(5,0, '              2.	    Tanggal	                           :	'.$row['tanggal']. '', '0', 1, 'L');
$pdf->Ln(0.5); 
$pdf->Cell(5,0, '              3.	   	Tempat	                            :	'.$row['tempat']. '', '0', 1, 'L');
$pdf->Ln(0.5); 
$pdf->Cell(5,0, '              4.	   	Barang Yang Hilang	        :	'.$row['barang']. '', '0', 1, 'L');
$pdf->Ln(1);
