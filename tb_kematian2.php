				...
				<section role="main" class="content-body">
					...
					<div class="row">
						 ...
						 <div class="col-12 col-lg-12">
							<h2 class="panel-title"><center>Tabel Kematian</center></h2>
									...
									<table class="table table-bordered table-striped table-condensed mb-none">
										<thead>
											<tr>
												...
												<th><center>Tempat Kematian</center></th>
												<th><center>Jam</center></th>
												<th><center>Sebab Kematian</center></th>
												<th><center>Yang Menerangkan</center></th>
										...
										<tbody id="table1">
													<?php
						$a="select * from kematian,kk,detail_kk where 
						...
						<td><center><?php echo $c['tanggal_kematian'];?></td>
						<td><center><?php echo $c['tempat_kematian'];?></td>
						<td><center><?php echo $c['jam'];?></td>
						<td><center><?php echo $c['sebab'];?></td>
						<td><center><?php echo $c['yang_menerangkan'];?></td>
						...
						<td>
						<?php if ($c['bc']=='1') { ?>
						<a href="ok_kematian.php?id=<?php echo $c['id_kematian'];?>" class="btn btn-warning">OK</a>
						<?php } else { ?>
						<a href="ok_kematian.php?id=<?php echo $c['id_kematian'];?>" disabled="disabled" class="btn btn-warning">OK</a>
						<?php } ?>
					</td>
						</tr>
						<?php } ?>
