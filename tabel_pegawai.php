				...
				<section role="main" class="content-body">
					...
					<div class="row">
						 ...
						 <div class="col-12 col-lg-12">
							...
							<center><h2 class="panel-title">Tabel data Pegawai</h2></center>
						...
						?>
						<tr>
						<td><center><?php echo $c['nip'];?></center></td>
						<td><center><?php echo $c['username'];?></center></td>
						
						<td><center><?php echo $c['nama_pegawai'];?></center></td>
						<td><center><?php echo $c['tempat_lahir'];?>,<?php echo $c['tanggal_lahir'];?></center></td>
						<td><center><?php echo $c['jabatan'];?></center></td>
						<td><center><?php echo $c['alamat'];?></center></td>
