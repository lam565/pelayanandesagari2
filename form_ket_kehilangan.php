							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Formulir Layanan: Surat Pengantar Kehilangan</h2>
									</header>
									<div class="panel-body">
										<form class="form-horizontal form-bordered" action="simpan_kehilangan.php" method="POST" enctype="multipart/form-data">
					
						<div class="">

												<?php
										include("connect.php"); //include config file 
										$sql="select * from kehilangan order by no_surat DESC";
								...
								<section class="panel">
									...
									<div class="panel-body">
											...
											<div class="">
												...
												<div class="col-md-6">
													<input type="text" required="required" class="form-control" name="hari" id="pendidikan" value="">
												</div><br><br>
												
											
											</div>
												<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Tanggal Kehilangan</label>
												<div class="col-md-6">
													<input type="date" required="required" class="form-control" name="tanggal" id="pendidikan" value="">
												</div><br><br>
												
											
											</div>
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Tempat Kehilangan </label>
												<div class="col-md-6">
													<input type="text" required="required" class="form-control" name="tempat" id="pendidikan" value="">
												</div><br><br>
												
											
											</div>
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Barang</label>
												<div class="col-md-6">
													<input type="text" required="required" class="form-control" name="barang" id="pendidikan" value="">
												</div><br><br>
