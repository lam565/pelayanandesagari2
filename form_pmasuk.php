							...
							<section class="panel">
								...
								<div class="panel-body">
									<form class="form-horizontal form-bordered" action="simpan_pindah_datang.php" method="POST" enctype="multipart/form-data">
										...
										$sql="select * from pindah_datang order by id_datang DESC";
										$results = mysqli_query($connect,$sql) or die("Error: ".mysqli_error($connect));
										$data = mysqli_fetch_array($results);
										$kodeawal=substr($data['id_datang'],7,3);
										$kodeawal=(int)$kodeawal+1;
										if($kodeawal<10){
											$kd='471.2/000'.$kodeawal.'/II/2020';
										...
										<div class="pull-right">
											<div class="col-lg-12">
												No.Surat
												<input type="text" name="no_surat" placeholder="No Surat" class="form-control" value="<?php echo $kd;?>">
											</div>
										</div>
