								...
								<div class="row tile_count">
									<div class="animated flipInY col-md-4 col-sm-4 col-xs-4 tile_stats_count">
										...
										<div class="right">
											...
											<?php
											$q=mysqli_query($connect,"SELECT count(NIK) AS jumlah FROM biodata_wni");
											$dt=mysqli_fetch_array($q);
											$jdt=$dt['jumlah'];
											?>
											<div class="count"><?php echo $dt['jumlah']; ?></div>
											<span class="count_bottom"><i class="green"></i> JIWA</span>
										</div>
									</div>
									<div class="animated flipInY col-md-4 col-sm-4 col-xs-4 tile_stats_count">
										<div class="left"></div>
										<div class="right">
											...
											<?php
											$q=mysqli_query($connect,"SELECT count(NIK) AS jumlah FROM biodata_wni WHERE JENIS_KLMIN='1'");
											$dt=mysqli_fetch_array($q);
											?>
											<div class="count"><?php echo $dt['jumlah']; ?></div>
									...
									<div class="animated flipInY col-md-4 col-sm-4 col-xs-4 tile_stats_count">
										...
										<div class="right">
											...
											<?php
											$q=mysqli_query($connect,"SELECT count(NIK) AS jumlah FROM biodata_wni WHERE JENIS_KLMIN='2'");
											$dt=mysqli_fetch_array($q);
											?>
											<div class="count"><?php echo $dt['jumlah']; ?></div>
											<span class="count_bottom"> JIWA</span>
