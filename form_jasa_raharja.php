							...
							<div class="col-lg-12">
								<section class="panel">
									...
									<div class="panel-body">
										<form class="form-horizontal form-bordered" action="simpan_jasa.php" method="POST" enctype="multipart/form-data">
					
						<div class="">

												<?php
										include("connect.php"); //include config file 
										$sql="select * from jasaraharja order by no_surat DESC";
						...
						<div class="col-md-12">
								...
								<section class="panel">
									...
									<div class="panel-body">
											...
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Tanggal Kejadian</label>
												<div class="col-md-6">
													<input type="date" required="required" class="form-control" name="tanggal_kejadian" id="tanggal_kejadian" value="">
												</div><br><br>
											...
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Tempat Kejadian</label>
												<div class="col-md-6">
													<input type="text" required="required" class="form-control" name="tempat_kejadian" id="tempat_kejadian" value="">
												</div><br><br>
											...
											<hr>
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">keterangan</label>
												<div class="col-md-6">
													<textarea type="text" required="required" class="form-control" name="keterangan" id="keterangan" value=""></textarea>
												</div><br><br><br>
