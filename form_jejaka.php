							...
							<div class="col-lg-12">
								<section class="panel">
									...
									<div class="panel-body">
										<form class="form-horizontal form-bordered" action="simpan_jejaka.php" method="POST" enctype="multipart/form-data">
					
						<div class="">

												<?php
										include("connect.php"); //include config file 
										$sql="select * from jejaka order by no_surat DESC";
						...
						<div class="col-md-12">
								...
								<section class="panel">
									...
									<div class="panel-body">
											...
											<hr>
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Saksi 1</label>
												<div class="col-md-6">
													<input type="text" required="required" class="form-control" name="saksi_1" id="saksi_1" value="">
												</div><br><br>
											...
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Saksi 2</label>
												<div class="col-md-6">
													<input type="text" required="required" class="form-control" name="saksi_2" id="saksi_2" value="">
												</div><br><br>
