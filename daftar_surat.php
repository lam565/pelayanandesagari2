				...
				<div class="row">
					...
					<div class="col-12 col-lg-12">
						<?php
							$print=$_GET['fp'].".php";
							$surat=$_GET['view'];
							$qsurat=mysqli_query($connect,"SELECT * FROM biodata_wni,".$surat." WHERE biodata_wni.NIK=".$surat.".NIK ORDER BY ".$surat.".no_surat DESC");
						?>
							<div class="panel-body">
								<center><h2 class="panel-title">Daftar </h2></center>
								<br>
								...
								<div class="table-responsive">
									<table class="table table-striped table-bordered data">
										...
										<tbody>
											<?php
											$no=1;
											while ($data=mysqli_fetch_array($qsurat)){
											?>

											<tr>
												<td><center><?php echo $no;?></center></td>
												<td><center><?php echo $data['no_surat'];?></center></td>
												<td><center><?php echo $data['NAMA_LGKP'];?></center></td>
												<td><center><?php echo $data['tanggal_permohonan'];?></center></td>
												<td><center><a href="surat/<?php echo $print."?nik=".$data['NIK']."&tgl=".$data['tanggal_permohonan']; ?>" target="_blank">Print</a></center></td>											
											</tr>
