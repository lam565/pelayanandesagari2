										...
										<div class="col-md-12">
											<section class="panel">
												...
												<div class="panel-body">
													...
													<div class="form-group">
														<label class="col-md-3 control-label" for="inputDefault">Nomor ITAS/ITAP</label>
														<div class="col-md-6">
															<input type="text" class="form-control" placeholder="Tempat Lahir" required="required" name="alamat" id="alamat" value="">
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-3 control-label" for="inputDefault">Tempat Terbit ITAS/ITAP</label>
														<div class="col-md-6">
															<input type="text" class="form-control" placeholder="Tempat Lahir" required="required" name="alamat" id="alamat" value="">
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-3 control-label" for="inputDefault">Tanggal Terbit ITAS/ITAP</label>
														<div class="col-md-6">
															<input type="text" class="form-control" placeholder="Tempat Lahir" required="required" name="alamat" id="alamat" value="">
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-3 control-label" for="inputDefault">Tanggal Akhir ITAS/ITAP</label>
														<div class="col-md-6">
															<input type="text" class="form-control" placeholder="Tempat Lahir" required="required" name="alamat" id="alamat" value="">
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-3 control-label" for="inputDefault">Tempat Datang Pertama</label>
														<div class="col-md-6">
															<input type="text" class="form-control" placeholder="Tempat Lahir" required="required" name="alamat" id="alamat" value="">
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-3 control-label" for="inputDefault">Tgl Kedatangan Pertama</label>
														<div class="col-md-6">
															<input type="text" class="form-control" placeholder="Tempat Lahir" required="required" name="alamat" id="alamat" value="">
														</div>
													</div>
