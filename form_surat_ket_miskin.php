							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Formulir Layanan: Surat Keterangan Miskin</h2>
									</header>
									<div class="panel-body">
										<form class="form-horizontal form-bordered" action="simpan_miskin.php" method="POST" enctype="multipart/form-data">
					
						<div class="">

												<?php
										include("connect.php"); //include config file 
										$sql="select * from s_miskin order by no_surat DESC";
						...
						<div class="col-md-12">
								...
								<section class="panel">
									...
									<div class="panel-body">
											...
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Nama Anak</label>
												<div class="col-md-6">
													<input type="text" class="form-control" required="required" name="nama_1" id="nama_1" value="">
												</div>
											</div><br><br>
												<div class="">
									            ...
									            <label class="col-md-3 control-label" for="inputDefault">NIK</label>
												<div class="col-md-6">
													<input type="text" class="form-control" name="NIK_1" id="NIK_1" value="">
												</div>
											</div><br><br>
											<div class="">
											<label class="col-md-3 control-label" for="inputDefault">Tempat & Tanggal Lahir</label>
												<div class="col-md-3">
													<input type="text" required="required" class="form-control" name="TMPT_LHR_1" id="TMPT_LHR_1" >
												</div>

												<div class="mb-md hidden-lg hidden-xl"></div>

												<div class="col-md-3">
													<input type="text" required="required" class="form-control" name="TGL_LHR_1" id="TGL_LHR_1" >
												</div>
											...
											<div class="">
												...
												<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Fakultas/Jurusan/Prodi</label>
												<div class="col-md-6">
													<input type="text" class="form-control" required="required" name="fak_jurusan_prodi" id="nama" value="">
												</div>
											</div><br><br>
												<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Kelas/semester</label>
												<div class="col-md-6">
													<input type="text" class="form-control" required="required" name="kelas_semester" id="nama" value="">
												</div>
											</div><br><br>
											<hr>
         ...
         source: "data.php", 
		   ...
		   select:function(event,data){
                    $('input[name=NIK_1]').val(data.item.NIK);
					 ...
					 $('input[name=TGL_LHR_1]').val(data.item.TGL_LHR);
