										...
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h5 class="title">Input Data Kepala Keluarga dan Anggota Keluarga WNI</h4>
														<p> </p>
													</div>
													<div class="summary-footer">
														<a  href="form_k_wni.php">Input Data</a>
													</div>
												</div>
											</div>
										</div>
									...
									<section class="panel panel-featured-left panel-featured-primary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Input Data Kepala Keluarga dan Anggota Keluarga Orang Asing</h4>
														<p></p>
													</div>
													<div class="summary-footer">
														<a  href="form_k_asing.php">Input Data</a>
													</div>
												</div>
											</div>
										</div>
									...
									<section class="panel panel-featured-left panel-featured-primary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Input Data Kepala Keluarga dan Anggota Keluarga WNI di Luar Negeri</h4>
														<p> </p>
													</div>
													<div class="summary-footer">
