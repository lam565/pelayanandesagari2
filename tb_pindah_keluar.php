		...
		<!-- end: sidebar -->
				...
				<section role="main" class="content-body">
					...
					<h2 class="panel-title"><span class="badge badge-pill badge-success">Alamat</span> Kalurahan Gari, Wonosari, Gunung Kidul, 55851 </h2>
									...
									<table class="table table-bordered table-striped table-condensed mb-none">
										<thead>
											<tr>
												...
												<th><center>Jenis Kepindahan</center></th>
						...
						<td><center><?php echo $c['alasan_pindah'];?></center></td>
						<td><center><?php echo $c['jenis_kepindahan'];?></center></td>
						
					<td><center><a href="cetak_perm_pindah.php?id=<?php echo $c['id_keluar']; ?>" target="_blank">CETAK</a></center></td>
