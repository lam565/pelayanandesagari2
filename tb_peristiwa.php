					...
					<header class="page-header">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title"><center>------Dokumen kependudukan------</center></h2>
							...
							<div class="panel-body">
								...
								<div class="table-responsive">
									<table class="table table-bordered table-striped table-condensed mb-none">
										...
										<tbody id="table1">
													<?php
						$qperistiwa=mysqli_query($connect,"SELECT * FROM peristiwa, biodata_wni,det_peristiwa 
						WHERE peristiwa.NIK=biodata_wni.NIK and peristiwa.id_peristiwa=det_peristiwa.id_peristiwa
						ORDER BY peristiwa.id_peristiwa DESC");
					
						while($c=mysqli_fetch_array($qperistiwa)){
						?>
						<tr>
						<td><center><?php echo $c['id_peristiwa'];?></center></td>
						...
						<td><center><?php echo $c['persyaratan'];?></center></td>
					
						<td><center><a href="peristiwa.php" target="_blank">CETAK</a></center></td>
