							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Formulir Surat Keterangan Penghasilan</h2>
									</header>
									<div class="panel-body">
										<form class="form-horizontal form-bordered" action="simpan_ket_penghasilan.php" method="POST" enctype="multipart/form-data">
					
						<div class="">

												<?php
										include("connect.php"); //include config file 
										$sql="select * from penghasilan order by no_surat DESC";
						...
						<div class="col-md-12">
								...
								<section class="panel">
									...
									<div class="panel-body">
											...
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Sekolah/Universitas</label>
												
												 <div class="col-md-6">
													<input type="text" class="form-control" required="required" name="sekolah" id="sekolah" value="">
												</div><br><br>
											
											
											</div>
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Fakultas/Prodi</label>
												
												 <div class="col-md-6">
													<input type="text" class="form-control" required="required" name="fakultas" id="fakultas" value="">
												</div><br><br>
											
											
											</div>
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Kelas</label>
												
												 <div class="col-md-6">
													<input type="text" class="form-control" required="required" name="kelas" id="kelas" value="">
												</div><br><br>
											...
											<div class="">
												...
												<div class="col-md-6">
													<input type="text" class="form-control" required="required" name="nama_ayah" id="nama_ayah" value="">
												</div>
											</div><br><br>
											<div class="">
											<label class="col-md-3 control-label" for="inputDefault">Tempat & Tanggal Lahir</label>
												<div class="col-md-3">
													<input type="text" required="required" class="form-control" name="tempat_lahir" id="tempat_lahir" >
												</div>

												<div class="mb-md hidden-lg hidden-xl"></div>

												<div class="col-md-3">
													<input type="text" required="required" class="form-control" name="tanggal_lahir" id="tanggal_lahir" >
												</div>
												...
												<label class="col-md-3 control-label" for="inputDefault">Alamat</label>
												<div class="col-md-6">
													<input type="text" class="form-control" required="required" name="ALAMAT_1" id="ALAMAT_1" value="">
												</div>
											</div><br><br>
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Pekerjaan</label>
												<div class="col-md-6">
													<input type="text" class="form-control" required="required" name="pekerjaan" id="pekerjaan" value="">
												</div>
											</div><br><br>
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Penghasilan</label>
												<div class="col-md-6">
													<input type="text" class="form-control" required="required" name="penghasilan" id="penghasilan" value="">
												</div>
											</div><br><br>
											<hr>
												<div class="">
												...
												<div class="col-md-6">
													<input type="text" class="form-control" required="required" name="nama_ibu" id="nama_ibu" value="">
												</div>
											</div><br><br>
											<div class="">
											<label class="col-md-3 control-label" for="inputDefault">Tempat & Tanggal Lahir</label>
												<div class="col-md-3">
													<input type="text" required="required" class="form-control" name="tempat_lahir_ibu" id="tempat_lahir_ibu" >
												</div>

												<div class="mb-md hidden-lg hidden-xl"></div>

												<div class="col-md-3">
													<input type="text" required="required" class="form-control" name="tanggal_lahir_ibu" id="tanggal_lahir_ibu" >
												</div>
												...
												<label class="col-md-3 control-label" for="inputDefault">Alamat</label>
												<div class="col-md-6">
													<input type="text" class="form-control" required="required" name="alamat_ibu" id="alamat_ibu" value="">
												</div>
											</div><br><br>
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Penghasilan</label>
												<div class="col-md-6">
													<input type="text" class="form-control" required="required" name="penghasilan_ibu" id="penghasilan_ibu" value="">
												</div>
											</div><br><br>
											<hr>
											
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Staf Pemerintah Desa</label>
												<div class="col-md-6">
													<select class="form-control" name="staf" id="staf">
<option>--Staf Pemerintah Desa--</option>
<?php
    ...
    $(function() { 
        $( "#nama_1").autocomplete({
         source: "data.php", 
           minLength:1,
		   select:function(event,data){
                    $('input[name=NIK_1]').val(data.item.NIK);
					 $('input[name=TMPT_LHR_1]').val(data.item.TMPT_LHR);
					 
					
					  $('input[name=ALAMAT_1]').val(data.item.ALAMAT);
					  $('input[name=nama_agama]').val(data.item.nama_agama);
					  $('input[name=pendidikan]').val(data.item.pendidikan);
         ...
         source: "data.php", 
		   ...
		   select:function(event,data){
                    $('input[name=NIK_1]').val(data.item.NIK);
					 ...
					 $('input[name=tanggal_lahir]').val(data.item.TGL_LHR);
...
/*autocomplete muncul setelah user mengetikan minimal2 karakter */
    $(function() { 
        $( "#nama_ibu").autocomplete({
         source: "data.php", 
           minLength:1,
		   select:function(event,data){
                    $('input[name=NIK_1]').val(data.item.NIK);
					 $('input[name=tempat_lahir_ibu]').val(data.item.TMPT_LHR);
					 $('input[name=tanggal_lahir_ibu]').val(data.item.TGL_LHR);
					
					  $('input[name=alamat_ibu]').val(data.item.ALAMAT);
					  $('input[name=nama_agama]').val(data.item.nama_agama);
					  $('input[name=pendidikan]').val(data.item.pendidikan);
