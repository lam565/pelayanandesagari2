							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Formulir Layanan: Surat Pengantar Beda Nama</h2>
									</header>
									<div class="panel-body">
										<form class="form-horizontal form-bordered" action="simpan_beda.php" method="POST" enctype="multipart/form-data">
					
						<div class="">

												<?php
										include("connect.php"); //include config file 
										$sql="select * from beda_nama order by no_surat DESC";
								...
								<section class="panel">
									...
									<div class="panel-body">
											...
											<label class="col-md-3 control-label" for="inputDefault">Tempat & Tanggal Lahir</label>
												<div class="col-md-3">
													<input type="text" required="required" class="form-control" name="TMPT_LHR" id="tempat_lahir" >
												</div>

												<div class="mb-md hidden-lg hidden-xl"></div>

												<div class="col-md-3">
													<input type="text" required="required" class="form-control" name="TGL_LHR" id="tanggal_lahir" >
												</div>
											...
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Agama</label>
												 ...
												 <div class="col-md-6">
													<input type="text" class="form-control" required="required" name="nama_agama" id="agama" value="">
												</div><br><br>
											...
											<hr>
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Nama Identitas</label>
												<div class="col-md-6">
													<input type="text" required="required" class="form-control" name="nama_id" id="nama_id" value="">
												</div><br><br>
												
											
											</div>
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Nomor Identitas</label>
												<div class="col-md-6">
													<input type="text" required="required" class="form-control" name="nomor" id="nomor" value="">
												</div><br><br>
											...
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Nama</label>
												<div class="col-md-6">
													<input type="text" required="required" class="form-control" name="nama" id="nama" value="">
												</div><br><br>
											...
											<div class="">
												...
												<div class="col-md-6">
													<input type="date" required="required" class="form-control" name="tgl" id="tgl" value="">
												</div><br><br>
											...
											<div class="">
												...
												<div class="col-md-6">
													<input type="text" required="required" class="form-control" name="jk" id="jk" value="">
												</div><br><br>
