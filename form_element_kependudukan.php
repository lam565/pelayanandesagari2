				...
				<section role="main" class="content-body">
					...
					<div class="row">
						...
						<?php } ?>
														...
														<h4 class="panel-title">B. Agama & Golongan Darah</h4><hr>
														<table id="tb_anggota" class="table">
															<thead>
																<tr>
																	<th>NIK</th>
						...
						<td><center><select name="dasar2" id="" class="form-control">
																<option value="">Pilih</option>
																<option value="Surat Keterangan">Surat Keterangan</option>
																<option value="Akta Kelahiran">Akta Kelahiran</option>
																<option value="Akta Perkawinan">Akta Perkawinan</option>
						...
						<td><center><?php echo $cw['nama_golongan'];?></center></td>
					<td><center><select name="golongan_darah" id="" class="form-control">
																<option value="">Pilih</option>
																<?php
															...
															<td><center><select name="dasar3" id="" class="form-control">
																<option value="">Pilih</option>
																<option value="Surat Keterangan">Surat Keterangan</option>
																<option value="Akta Kelahiran">Akta Kelahiran</option>
																<option value="Akta Perkawinan">Akta Perkawinan</option>
						...
						<?php } ?>
														...
														<h4 class="panel-title">C. Status Perkawinan & Status Hubungan</h4><hr>
														<table id="tb_anggota" class="table">
															<thead>
																<tr>
																	<th>NIK</th>
						...
						<td><center><?php echo $cw['NIK'];?></center></td>
						<td><center><?php echo $cw['NAMA_LGKP'];?></center></td>
						<td><center><?php echo $cw['status_perkawinan'];?></center></td>
						<td><center><select name="status_perkawinan" id="" class="form-control">
																<option value="">Pilih</option>
																<?php
						...
						<td><center><select name="dasar4" id="" class="form-control">
																<option value="">Pilih</option>
																<option value="Surat Keterangan">Surat Keterangan</option>
																<option value="Akta Kelahiran">Akta Kelahiran</option>
																<option value="Akta Perkawinan">Akta Perkawinan</option>
						...
						<td><center><?php echo $cw['status_hubungan'];?></center></td>
					<td><center><select name="status_hubungan" id="" class="form-control">
																<option value="">Pilih</option>
																<?php
															...
															<td><center><select name="dasar5" id="" class="form-control">
																<option value="">Pilih</option>
																<option value="Surat Keterangan">Surat Keterangan</option>
																<option value="Akta Kelahiran">Akta Kelahiran</option>
																<option value="Akta Perkawinan">Akta Perkawinan</option>
						...
						<td><center><?php echo $cw['jenis_kelamin'];?></center></td>
					<td><center><select name="jenis_kelamin" id="" class="form-control">
																<option value="">Pilih</option>
																<?php
															...
															<td><center><select name="dasar8" id="" class="form-control">
																<option value="">Pilih</option>
																<option value="Surat Keterangan">Surat Keterangan</option>
																<option value="Akta Kelahiran">Akta Kelahiran</option>
																<option value="Akta Perkawinan">Akta Perkawinan</option>
						...
						<?php } ?>
														...
														<h4 class="panel-title">E. Tempat Lahir & Tanggal Lahir</h4><hr>
														<table id="tb_anggota" class="table">
															<thead>
																<tr>
																	<th>NIK</th>
						...
						<td><center><?php echo $cw['NIK'];?></center></td>
						<td><center><?php echo $cw['NAMA_LGKP'];?></center></td>
						<td><center><?php echo $cw['TMPT_LHR'];?></center></td>
						<td><center><input type="text" placeholder="Tempat Lahir" class="form-control" name="tempat_lhr" id="tempat_lhr" value=""></center></td>
						<td><center><select name="dasar9" id="" class="form-control">
																<option value="">Pilih</option>
																<option value="Surat Keterangan">Surat Keterangan</option>
																<option value="Akta Kelahiran">Akta Kelahiran</option>
																<option value="Akta Perkawinan">Akta Perkawinan</option>
						...
						<td><center><?php echo $cw['TGL_LHR'];?></center></td>
						<td><center><input type="text" placeholder="Tanggal lahir" class="form-control" name="tgl_lhr" id="tgl_lhr" value=""></center></td>
						<td><center><select name="dasar10" id="" class="form-control">
																<option value="">Pilih</option>
																<option value="Surat Keterangan">Surat Keterangan</option>
																<option value="Akta Kelahiran">Akta Kelahiran</option>
																<option value="Akta Perkawinan">Akta Perkawinan</option>
