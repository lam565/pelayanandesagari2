						...
						<div class="col-lg-12">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Form Perceraian</h2>
								</header>
								<div class="panel-body">
									...
									<div class="col-md-12">
										<section class="panel">
											<header class="panel-heading">
												<h2 class="panel-title">Bagi Pemohon Pembatalan Perkawinan Harap Mengisi Data di bawah ini :</h2>
											</header>
											<div class="panel-body">
												...
												<div class="form-group">
													<label class="col-md-3 control-label" for="inputDefault">TANGGAL PELAPORAN PERKAWINAN DI LUAR NEGERI</label>
													<div class="col-md-6">
														<input type="text" class="form-control" placeholder="Nama Ibu" required="required" name="nama_ibu" id="nama_ibu" value="">
													</div>
												</div>
