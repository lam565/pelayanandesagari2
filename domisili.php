							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Formulir Layanan: Surat Pengantar Domisili</h2>
									</header>
									<div class="panel-body">
										<form class="form-horizontal form-bordered" action="simpan_domisili.php" method="POST" enctype="multipart/form-data">
					
						<div class="">

												<?php
										include("connect.php"); //include config file 
										$sql="select * from domisili order by no_surat DESC";
										...
										$kd='474/'.sprintf("%04d",$kodeawal).'/II/2020';
