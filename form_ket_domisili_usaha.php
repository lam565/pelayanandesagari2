							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Formulir Layanan: Surat Pengantar Domisili Usaha</h2>
									</header>
									<div class="panel-body">
										<form class="form-horizontal form-bordered" action="simpan_ket_domisili_usaha.php" method="POST" enctype="multipart/form-data">
					
						<div class="">

												<?php
										include("connect.php"); //include config file 
										$sql="select * from domisili_usaha order by no_surat DESC";
										$results = mysqli_query($connect,$sql) or die("Error: ".mysqli_error($connect));
										$data = mysqli_fetch_array($results);
										$kodeawal=substr($data['no_surat'],5,4)+1;
										if($kodeawal<10){
											$kd='460/000'.$kodeawal.'/II/2020';
						...
						<div class="col-md-12">
								...
								<section class="panel">
									...
									<div class="panel-body">
											...
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Bidang Usaha</label>
												<div class="col-md-6">
													<input type="text" required="required" class="form-control" name="bidang_usaha" id="pendidikan" value="">
												</div><br><br>
												
											
											</div>
												<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Jenis Usaha</label>
												<div class="col-md-6">
													<input type="text" required="required" class="form-control" name="jenis_usaha" id="pendidikan" value="">
												</div><br><br>
												
											
											</div>
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Lokasi Usaha</label>
												<div class="col-md-6">
													<input type="text" required="required" class="form-control" name="lokasi_usaha" id="pendidikan" value="">
												</div><br><br>
