				...
				<section role="main" class="content-body">
					...
					<div class="row">
						 ...
						 <div class="col-12 col-lg-12">
							...
							<center><h2 class="panel-title">Tabel data Warga</h2></center>
							<br>
						...
						pendidikan_terakhir.pendidikan,agama.nama_agama,status_perkawinan.status_perkawinan,pekerjaan.pekerjaan
						from biodata_wni,data_keluarga,agama,pendidikan_terakhir,status_perkawinan,pekerjaan,jenis_kelamin
