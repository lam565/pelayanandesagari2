							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Formulir Layanan: Surat Pengantar Belum Menikah</h2>
									</header>
									<div class="panel-body">
										<form class="form-horizontal form-bordered" action="simpan_blm_mn.php" method="POST" enctype="multipart/form-data">
					
						<div class="">

												<?php
										include("connect.php"); //include config file 
										$sql="select * from belum_menikah order by no_surat DESC";
						...
						<div class="col-md-12">
								...
								<section class="panel">
									...
									<div class="panel-body">
											...
											<hr>
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Keperluan</label>
												<div class="col-md-6">
													<textarea type="text" required="required" class="form-control" name="keperluan" id="keperluan" value=""></textarea>
												</div><br><br><br>
