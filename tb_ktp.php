				...
				<section role="main" class="content-body">
					...
					<div class="row">
						 ...
						 <div class="col-12 col-lg-12">
							<h2 class="panel-title"><center>Tabel Permohonan KTP</center></h2>
							...
							<div class="panel-body">
								...
								<div class="table-responsive">
									<table class="table table-bordered table-striped table-condensed mb-none">
										...
										<tbody id="table1">
													<?php
						$a="select * from suket_ektp,biodata_wni,data_keluarga where 
						suket_ektp.NIK=biodata_wni.NIK AND data_keluarga.NO_KK=biodata_wni.NO_KK
						 ";
						$b=mysqli_query($connect,$a) or die ("error:".mysqli_error($connect));
						while($c=mysqli_fetch_array($b)){
						?>
						<tr>
						<td><center><?php echo $c['id_ektp'];?></center></td>
						<td><center><?php echo $c['NIK'];?></center></td>
						<td><center><?php echo $c['NAMA_LGKP'];?></center></td>

						<td><center><?php echo $c['ALAMAT'];?></td>
						<td><center><?php echo $c['tanggal_permohonan'];?></center></td>
						<td><center><?php echo $c['jenis_permohonan'];?></center></td>
						
						<?php if ($c['jenis_permohonan']=='Baru') { ?>
						<td><center><a href="cetak_permohonan.php?nik=<?php echo $c['NIK']; ?>" target="_blank">CETAK</a></center></td>
						<?php } ?>
						<?php if ($c['jenis_permohonan']=='Perubahan') { ?>
						<td><center><a href="cetak_permohonan_ktp_perubahan_status.php?nik=<?php echo $c['NIK']; ?>" target="_blank">CETAK</a></center></td>
						<?php } ?>
						<?php if ($c['jenis_permohonan']=='Penggantian') { ?>
						<td><center><a href="cetak_permohonan_ktp_hilang_rusak.php?nik=<?php echo $c['NIK']; ?>" target="_blank">CETAK</a></center></td>
						<?php } ?>
