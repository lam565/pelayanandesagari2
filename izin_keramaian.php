							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Formulir Layanan: Surat Pengantar Izin Keramaian</h2>
									</header>
									<div class="panel-body">
										<form class="form-horizontal form-bordered" action="simpan_keramaian.php" method="POST" enctype="multipart/form-data">
					
						<div class="">

												<?php
										include("connect.php"); //include config file 
										$sql="select * from keramaian order by no_surat DESC";
								...
								<section class="panel">
									...
									<div class="panel-body">
											...
											<div class="">
												...
												<div class="col-md-6">
													<input type="text" required="required" class="form-control" name="pendidikan" id="pendidikan" value="">
												</div><br><br>
											...
											<hr>
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Hari</label>
												<div class="col-md-6">
													<input type="text" required="required" class="form-control" name="hari" id="hari" value="">
												</div><br><br>
											...
											<div class="">
												...
												<div class="col-md-6">
													<input type="date" required="required" class="form-control" name="tanggal" id="tanggal" value="">
												</div><br><br>
												
											
											</div>
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Waktu</label>
												<div class="col-md-6">
													<input type="text" required="required" class="form-control" name="waktu" id="waktu" value="">
												</div><br><br>
												
											
											</div>
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Jenis Kegiatan</label>
												<div class="col-md-6">
													<input type="text" required="required" class="form-control" name="jenis" id="jenis" value="">
												</div><br><br>
												
											
											</div>
											<div class="">
												<label class="col-md-3 control-label" for="inputDefault">Lokasi Kegiatan</label>
												<div class="col-md-6">
													<input type="text" required="required" class="form-control" name="lokasi" id="lokasi" value="">
												</div><br><br>
