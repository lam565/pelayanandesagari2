							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Formulir Layanan: Surat Pengantar</h2>
									</header>
									<div class="panel-body">
										<form class="form-horizontal form-bordered" action="simpan_keterangan.php" method="POST" enctype="multipart/form-data">
					
						<div class="">

												<?php
										include("connect.php"); //include config file 
										$sql="select * from pengantar order by no_surat DESC";
								...
								<section class="panel">
									...
									<div class="panel-body">
											...
											<div class="">
												...
												<div class="col-md-6">
													<input type="text" required="required" class="form-control" name="keperluan" id="keperluan" value="">
												</div><br><br>
